            ...
            <div className='auth-card' style={{ maxWidth: step === 1 ? 560 : 460 }}>
                ...
                {step === 1 ? (
                    <>
                        ...
                        <p className='auth-sub'>How will you choose LogiTrack?</p>
                    ...
                    <form onSubmit={submit}>
                        <div className='form-group'>
                            ...
                            <input className='form-control' type="text" name='name' placeholder='Sachithra' 
                        ...
                        <div className='form-group'>
                            ...
                            <input className='form-control' type='tel' name='phone' placeholder='0772402325'
                                value={form.phone} onChange={handle} required autoComplete='tel' />
                        </div>
